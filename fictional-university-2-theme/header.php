<!DOCTYPE html>
<!-- used to set site content language -->
<html <?php language_attributes(); ?>>

  <head>
    <!-- specifies which characters will be used in the site content -->
    <meta charset="<?php bloginfo('charset'); ?>">
     <!-- tells browsers on mobile devices to display at native resolution in conjunction with responsive css-->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <?php wp_head(); ?> </head>

<!-- adds values depending which page is being viewed in browser-->
  <body <?php body_class(); ?>>
